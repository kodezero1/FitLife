...
import BodyOfMuscle from "../../svg/BodyOfMuscle";

type Props = {
  selectedMuscleGroups: [Exercise["muscleGroup"], { count: number; exerciseIds: string[] }][];
};

const BodyDiagram = ({ selectedMuscleGroups }: Props) => {
